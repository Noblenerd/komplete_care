...
<head>
  ...
  <!-- plugins:css -->
  <link rel="stylesheet" href="<?php echo e(url('/')); ?>/vendors/feather/feather.css">
  <link rel="stylesheet" href="<?php echo e(url('/')); ?>/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" href="<?php echo e(url('/')); ?>/vendors/css/vendor.bundle.base.css">
  <!-- endinject -->
  <!-- Plugin css for this page -->
  <link rel="stylesheet" href="<?php echo e(url('/')); ?>/vendors/datatables.net-bs4/dataTables.bootstrap4.css">
  <link rel="stylesheet" href="<?php echo e(url('/')); ?>/vendors/ti-icons/css/themify-icons.css">
  <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/js/select.dataTables.min.css">
  <!-- End plugin css for this page -->
  <!-- inject:css -->
  <link rel="stylesheet" href="<?php echo e(url('/')); ?>/css/vertical-layout-light/style.css">
  <!-- endinject -->
  <link rel="shortcut icon" href="<?php echo e(url('/')); ?>/images/fav.png" />
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="<?php echo e(url('admin.dashboard')); ?>"><img src="<?php echo e(url('/')); ?>/<?php echo e($set->image); ?>" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="<?php echo e(url('admin.dashboard')); ?>"><img src="<?php echo e(url('/')); ?>/<?php echo e($set->image); ?>" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?php echo e(url('/')); ?>/images/faces/face28.jpg" alt="profile"/>
            </a>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu" style="list-style-type:none;">
                <li class="nav-item"> <a class="nav-link" href="<?php echo e(route('admin.quotes')); ?>">Quotes</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elemen">
              <ul class="nav flex-column sub-menu" style="list-style-type:none;">
              <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin.testimony')); ?>">All Testimonies</a></li>
...
<footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <?php echo e(date('Y')); ?>. All rights reserved.</span>
...
<?php /**PATH C:\wamp64\www\myprojects\logistics\resources\views/master.blade.php ENDPATH**/ ?>