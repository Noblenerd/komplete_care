                      ...
                      <div class="modal-content" style="background-image:url('<?php echo e(url('/')); ?>/images/carousel/banner_4.jpg');background-repeat:no-repeat;background-size:cover;">
                        ...
                        <div class="modal-body">
                          <form method="post" action="<?php echo e(route('site.update')); ?>" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                <input type="text" class="form-control form-control-lg" name="homepage_video" value="<?php echo e($vol->homepage_video); ?>" id="exampleInputEmail1" placeholder="Homepage Video Link">
                              </div>
                              <div class="form-group">
                                  Site Favicon:<br>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\myprojects\logistics\resources\views//admin/settings.blade.php ENDPATH**/ ?>